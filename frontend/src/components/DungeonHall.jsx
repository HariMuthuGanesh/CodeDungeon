...
function SectionDoor({ title, subtitle, sectionNum, rooms, activeRoomId, onSelectRoom, isOpen, anyOpen, onToggle }) {
  ...
  return (
    <div
      ...
      className={`relative rounded-t-[100px] overflow-hidden bg-stone-texture transition-all duration-700 ease-in-out flex flex-col group ${
        isOpen ? 'cursor-default' : 'cursor-pointer hover:bg-stone-800'
      }`}
      style={{
        flex: flexValue,
